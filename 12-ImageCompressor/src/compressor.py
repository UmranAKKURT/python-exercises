...
class ImageCompressor:
    ...
    def smart_compress(self, input_path, output_path, target_size_kb=500):
        low = 5
        high = 100
        best_quality = 80
        ...
        while low <= high:
            quality = (low + high) // 2
            self.compress(input_path, output_path, quality)
        ...
        self.compress(input_path, output_path, best_quality)
        return best_quality
